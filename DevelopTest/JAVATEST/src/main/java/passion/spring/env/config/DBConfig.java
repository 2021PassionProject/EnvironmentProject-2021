package passion.spring.env.config;
...
public class DBConfig { // dataSource bean 객체 설정 및 생성
    // @Component : 개발자가 정의한 클래스로부터 Bean 객체를 생성하는 애노테이션
...
//        dataSourceBuilder.url("spring.datasource.hikari.jdbc-url");
...
//        dataSource.setUrl(environment.getProperty("spring.datasource.hikari.jdbc-url"));    // "jdbc:oracle:thin:@localhost:1521:XE"
